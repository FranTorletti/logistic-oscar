  ...
  .controller('AuthCtrl', ['$scope', '$rootScope', '$http', '$location', 'Global',
    function($scope, $rootScope, $http, $location, Global) {
      ...
      $scope.closeAlert = function(index) {
        $scope.global.index = false;
      };

      $scope.addAlert = function(type,message,btn){
        $scope.global.type = type;
        $scope.global.message = message;
        $scope.global.index = true;
        $scope.global.btn = btn;
      };
      ...
      $scope.sendMessage = function(){
        $http.post('/contact', {
            client : $scope.client
              ...
              $scope.addAlert('alert-info','Mensaje enviado exitosamente','btn-info');
              $scope.client.name = '';
